...
(** Replace a term [d] of the form [Decidable A] with [inl x] if we have a term [a : A] showing that [A] is true. *)
...
(** Replace a term [d] of the form [Decidable A] with [inr na] if we have a term [n : not A] showing that [A] is false. *)
Ltac decidable_false d n :=
  generalize d;
