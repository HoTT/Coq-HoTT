...
(** This command makes it so that when "-mangle-names" is passed to coqc, as it is done in the makefile, the autogenerated names will be mangled in such a way that is more readable than the default. *)
...
Arguments irreflexivity {A} _ {Irreflexive} _ _ : rename.
