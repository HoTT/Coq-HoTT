...
(* We choose to define these outside the module because otherwise you have to import the module to activate them, and it seems preferable to keep a more fine-grained namespace.*)
