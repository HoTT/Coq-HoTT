...
Section Descent.
  ...
  Proof.
    ...
    - intros a b r.
      ...
      + lhs napply (ap (fun x => (transport _ x _)) (inv_V (gqglue r))).
        napply (transport_fam_gqdescent_gqglue _ _ _).
  Defined.
  ...
  Definition gqdepdescent_ind {Pe : gqDescent R}
    ...
    Proof.
      ...
      rhs napply (apD (gqdds_sect f b) (transport_fam_gqdescent_gqglue Pe r pa)).
  ...
  Proof.
    ...
    - intros [x px]; revert x px.
      ...
      + intros a b r pa; cbn.
        ...
        napply (GraphQuotient_rec_beta_gqglue _ _ (a; pa) (b; _) (r; 1)).
  Defined.
