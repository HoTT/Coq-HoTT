...
Proof.
  intros a; apply isequiv_contr_hfiber.
  apply istruncmap_from_functor_sigma.
  red; by apply contr_hfiber_isequiv.
Defined.
...
Proof.
  intros x y. apply isequiv_contr_hfiber,_.
Defined.
...
Definition isembedding_isequiv_ap {A B} (f : A -> B) `{!forall x y, IsEquiv (@ap _ _ f x y)}
  : IsEmbedding f.
Proof.
  apply istruncmap_from_ap. intros x y;red;apply contr_hfiber_isequiv,_.
Defined.
