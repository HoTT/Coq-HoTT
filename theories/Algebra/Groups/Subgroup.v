...
(** Note that this will not automatically be a hprop. Notice that if [X] already contained the unit of the group, then there are at least two different inhabitants of this family at the unit. We can fix this by propositionally truncating. *)
