...
Global Instance isrightideal_rightideal {R} (I : RightIdeal R)
  : IsRightIdeal (R:=R) I
...
Proof.
  intros x; split; rapply (functor_subgroup_generated _ _ (Id _)); intros r []; by nrapply ipn_in.
Defined.
